...
<script>
    ...
    var x,y,z;
    var materials;
    var cube, cubeMesh, cart, cartMesh, stock, stockMesh, delivery, deliveryMesh;
    ////////////////////////
    init();
    animate();
    ...
    function init() {
        ...
        //cameraCube = new THREE.PerspectiveCamera( 45, window.innerWidth / window.innerHeight,1, 100 );
        ...
        //////Creating GROUND FLOOR AND ADD TEXTURE TO THE MESH/////////
    ...
    function animate() {
        ...
        if(distance <= 685 && distance <= 580){
            ...
            //THREE.ScenUtils.traverseHierarchy(cartMesh, function(object) {cartMesh.visible = false});
        }
